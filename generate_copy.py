...
LOGDIR = './logdir'
WINDOW = 8000
WAVENET_PARAMS = './wavenet_audio_params.json'
SAVE_EVERY = None
...
def create_seed(filename,
    ...
    print('quantized type{0}, shape{1}'.format(quantized.dtype, quantized.shape))
...
def main():
    ...
    #todo: when shape is not specified, placeholder can take in a tensor of any shape
